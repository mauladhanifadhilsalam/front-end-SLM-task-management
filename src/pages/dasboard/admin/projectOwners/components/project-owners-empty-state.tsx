...
export const ProjectOwnersSearchEmptyState: React.FC<
  SearchEmptyStateProps
> = ({ query, onClear, onAddOwner }) => {
  return (
...
export const ProjectOwnersEmptyState: React.FC<EmptyStateProps> = ({
  onAddOwner,
}) => {
  return (
    <Card className="bg-background border-t">
      ...
      <div className="p-6">
        <p className="text-sm text-muted-foreground">
          Tambahkan project owner untuk mulai mengelola kepemilikan dan
          akses proyek.
        </p>
        <div className="mt-4">
          <Button onClick={onAddOwner}>
