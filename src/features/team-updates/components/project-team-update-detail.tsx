...
type ProjectTeamUpdateDetailProps = {
    title?: string
    description?: string
    createLabel?: string
    createPath?: string
...
export function ProjectTeamUpdateDetail({ 
    title,
    description,
    createLabel,
    createPath,
    ...
    // Determine base path based on role if not provided
    const finalBasePath = basePath || (isDeveloper
    ...
    const handleBack = () => {
        navigate(finalBasePath)
    }

    const handleViewUpdate = (id: number) => {
        navigate(`${finalBasePath}/view/${id}`)
    }

    const handleEditUpdate = (id: number) => {
        navigate(`${finalBasePath}/edit/${id}`)
    }
                ...
                <div className="flex items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            {title ? `${title} Details` : "Team Update Details"}
                        </p>
                        <Button
                            variant="ghost"
                            size="sm"
            ...
            <Card>
                <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div className="pt-1">
                            <CardTitle className="text-xl">{title || "Team Updates"}</CardTitle>
                            <CardDescription>
                                {description || "All daily standup updates for this project"}
                            </CardDescription>
                        </div>
