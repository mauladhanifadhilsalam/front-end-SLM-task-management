          ...
          {loading ? (
            ...
            projects.map((p) => (
              <tr key={p.id} className="border-t text-center">
                {columns.id && <td className="px-4 py-3">{p.id}</td>}
                {columns.name && <td className="px-4 py-3">{p.name}</td>}
                {columns.categories && (
                  <td className="px-4 py-3">
                ...
                {columns.actions && (
                  <td className="px-4 py-3">
                    <div className="flex justify-center gap-5">
                      <Link to={`${basePath}/projects/view/${p.id}`}>
                        <IconEye className="h-4 w-4 text-muted-foreground hover:text-foreground" />
                      </Link>
                      <Link to={`${basePath}/projects/edit/${p.id}`}>
